...
***
#<center>Restaurant selection voting system</center>
***
...
***
###<center>Swagger REST Api Documentation</center>
- http://localhost:8080/swagger-ui.html
- http://localhost:8080/v2/api-docs
####<center><pre>to check http requests, use <a href="HttpRequest">/HttpRequest</a> folder (<a href="HttpRequest/User.http">User</a>,<a href="HttpRequest/Vote.http">Vote</a>,<a href="HttpRequest/Restaurant.http">Restaurant</a>,<a href="HttpRequest/Dish.http">Dish</a>)</pre></center>
***
###<center>curl samples</center>

####<center>`Admin`</center>

####<center>AdminRestController</center>
...
<br>
<br>
####<center>AdminVoteRestController</center>
...
<br>
<br>
####<center>RestaurantRestController</center>
...
<br>
<br>
####<center>DishRestController</center>
...
####<center>ProfileRestController</center>
...
<br>
<br>
####<center>ProfileVoteRestController</center>
